...
class NuScenes3DDataset(Dataset):
    ...
    def _format_bbox(self, results, jsonfile_prefix=None, tracking=False):
        ...
        for sample_id, det in enumerate(track_iter_progress(results, desc="Converting detection format")):
            annos = []
    ...
    def format_motion_results(self, results, jsonfile_prefix=None, tracking=False, thresh=None):
        ...
        print("Start to convert detection format...")
        for sample_id, det in enumerate(track_iter_progress(results, desc="Converting motion format")):
            annos = []
            boxes = output_to_nusc_box(
    ...
    def _evaluate_single_motion(self,
        ...
        """
        from nuscenes import NuScenes
        from .motion_eval_uniad import NuScenesEval as NuScenesEvalMotion
